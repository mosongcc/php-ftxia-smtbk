...
<head><title>微信支付DEMO-订单查询</title>
...
<body>
    <form name="form1" method="post" action="view_post_action.php" id="form1" target="_blank">
    ...
    <div>
		...
		<tr>
			...
			<tr>
                ...
                <td>
                    <input name="remark" type="text" id="remark" value='测试' />
                </td>
