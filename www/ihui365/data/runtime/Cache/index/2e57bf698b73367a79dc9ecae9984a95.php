	...
	<div class="jiu-nav <?php echo C('ftx_site_width');?>  seclevelinner">
		<div class="nav-item  ">
			<div class="item-list">
				...
				<?php if(is_array($tag_list)): $i = 0; $__LIST__ = $tag_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bcate): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('jiu/index',array('tag'=>$bcate['id']));?>" class=" <?php if($tag == $bcate['id']): ?>active<?php endif; ?>" ><span></span><?php echo ($bcate["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
				</ul>
			</div>
		</div>
	</div>
