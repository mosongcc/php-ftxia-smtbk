...
<div class="main <?php echo C('ftx_site_width');?> clear">
	<div class="huan-login clear">
		...
		<div class="nav-userinfo fl">
			<div class="user-img"><a class="userinfo-img" href="<?php echo U('user/index');?>"><img src="<?php echo avatar($info['id'], 100);?>" width="80" height="80" /></a></div>
	...
	<div class="huan-list clear">
		<ul class="goods-list <?php echo C('ftx_site_wc');?> clear">
		<?php if(is_array($item_list)): $i = 0; $__LIST__ = $item_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 4 );++$i;?><li   class="<?php if(($mod) == "3"): ?>last<?php endif; ?>">
				<div class="list-good buy">
					<div class="good-pic huan">
						<a target="_blank" href="<?php echo U('gift/detail', array('id'=>$item['id']));?>"><img src="<?php echo attach(str_replace('_s.'.array_pop(explode('.', $item['img'])), '_b.'.array_pop(explode('.', $item['img'])), $item['img']), 'score_item');?>" alt="<?php echo ($item["title"]); ?>" class="lazy"   /></a>
					</div>
					<h5 class="good-title"><a target="_blank" href="<?php echo U('gift/detail', array('id'=>$item['id']));?>"><?php echo ($item["title"]); ?></a></h5>
					<div class="title-tips">
						<span class="fl">开始时间：<em class="old-price"><?php echo (date("Y-m-d",$item["start_time"])); ?></em></span>
						<span class="fr">剩余：<em class="org_2"><?php echo ($item["stock"]); ?></em>份</span>
					</div>
										<div class="good-price clear">
						<span class="price-current"><?php echo ($item["score"]); ?><em class="unit">积分</em></span>
						<div class="btn-new buy">
							<a target="_blank" href="<?php echo U('gift/detail', array('id'=>$item['id']));?>"><span>我要兑换</span></a>
						</div>
					</div>
				</div>
			</li><?php endforeach; endif; else: echo "" ;endif; ?>
	...
	<div class="page">
		<div class="pageNav"><?php echo ($page_bar); ?></div>
	</div>
</div>
