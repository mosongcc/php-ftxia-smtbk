...
<link rel="stylesheet" type="text/css" href="__STATIC__/jky/css/help.css" />
<script type="text/javascript" src="__STATIC__/jky/js/help.js"></script>
</head>
<body>
<!-- 头部开始 -->
<div id="toolbar">
...
<!--OLD头部结束-->
	...
	<div class="jiu_help <?php echo C('ftx_site_width');?>">
		<div style="position: absolute;">
			<div id="lr_float" style="position: static; top: -205px;">
				...
				<div class="help_title fl">
					<dl>
						<dt>帮助中心</dt>
						<?php if(is_array($helps)): $i = 0; $__LIST__ = $helps;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><dd <?php if($vol["id"] == $id): ?>class="cur"<?php endif; ?>><a href="<?php echo U('help/read',array('id'=>$vol['id']));?>"><?php echo ($vol["title"]); ?></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>
					</dl>
				</div>
			</div>
		</div>
		<div class="help_content fr">
						<div class="help_txt">
				<div class="help_list">
					<h3 class="mb10"><?php echo ($help["title"]); ?></h3>
					 <?php echo ($help["info"]); ?>
				</div>
			</div>
					</div>
