...
<script charset="utf-8" type="text/javascript" src="__STATIC__/8mobcom/js/jquery.validate.js" ></script>
<script>
$(function(){
	 ...
	 $('#infoset').validate({
        ...
        rules : {
            old_password : {
                ...
                byteRange: [6,20],
				remote   : {
                    url :'<?php echo U('ajax/check_oldpwd');?>',
                    type:'post',
                    data:{
                        oldpass : function(){ return $('#old_password').val();},uid:<?php echo ($info["id"]); ?>                   },
                    beforeSend:function(){
...
$(function(){
	...
	$('.left-menu-ul li').each(function(i){
		...
		<div class="right">
			<div class="menu-tag">
				<ul>
					<li id="info"><a href="<?php echo U('user/info');?>">帐户资料</a></li>
					<li id="pwd"><a href="<?php echo U('user/password');?>">修改密码</a></li>
					<li id="avatar"><a href="<?php echo U('user/avatar');?>">头像设置</a></li>
					<li id="apilogin"><a href="<?php echo U('user/bind');?>">帐号绑定</a></li>
				</ul>
			</div>
			<script>
			...
			<form id="infoset" name="form1" action="<?php echo U('user/info',array('do'=>'myinfo'));?>" method="post" class="ml30 mt30">
				<div class="address">
					<ul>
						<li>
							<div class="user">
						...
						<li>
							<div class="user">
								<label>QQ号码：</label>
								<input name="qq" type="text" id="qq" value="<?php echo ($info["qq"]); ?>"  onkeyup="value=value.replace(/[^\d]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" size="20" maxlength="50" style="width:150px;" class="ddinput"/>
							</div>
							<div class="error-box">
						...
						<li>
							<div class="user">
								<label>电子邮箱：</label>
								<input name="email" type="text" id="email" value="<?php echo ($info["email"]); ?>" style="width:150px;" class="ddinput"/>
							</div>
							<div class="error-box">
						...
						<li>
							<div class="user">
								<label>真实姓名：</label>
								<input name="realname" type="text" id="realname" value="<?php echo ($info["realname"]); ?>" style="width:150px;" class="ddinput"/>
							</div>
							<div class="error-box">
						...
						<li>
							<div class="user">
								<label>手机号码：</label>
								<input name="mobile" type="text" id="mobile" value="<?php echo ($info["mobile"]); ?>" style="width:150px;" class="ddinput"/>
							</div>
							<div class="error-box">
								<label class="warn">请务必填写正确</label>
							</div>
						...
						<li>
							<div class="user">
								<label>详细地址：</label>
								<input name="address" type="text" id="address" value="<?php echo ($info["address"]); ?>" style="width:250px;" class="ddinput"/>
							</div>
							<div class="error-box">
								<label class="warn">请务必填写正确</label>
							</div>
