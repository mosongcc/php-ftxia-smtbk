...
<div class="jiu-nav-main">
	<div class="jiu-nav <?php echo C('ftx_site_width');?>">
		<div class="nav-item ">
			<div class="item-list">
				<ul>
				<li><a href="<?php echo U('dapei/index');?>" <?php if(empty($cid)): ?>class="active"<?php endif; ?>>全部</a></li>
				<?php if(is_array($acats)): $i = 0; $__LIST__ = $acats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('dapei/cate',array('id'=>$vol['id']));?>" <?php if($vol["id"] == $cid): ?>class="active"<?php endif; ?>><?php echo ($vol["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?> 
				</ul>
			</div>
		</div>
	</div>
...
<?php if(is_array($dapei_list)): $i = 0; $__LIST__ = $dapei_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dapei): $mod = ($i % 5 );++$i;?><div class="mate-box ks-waterfall">
              <div class="info-wrap">
                  <div class="info-img">
                    <a href="<?php echo U('dapei/read',array('id'=>$dapei['id']));?>" target="_blank">
                      <img src="<?php echo ($dapei["pic_url"]); ?>_240x10000Q90.jpg" alt="<?php echo ($dapei["title"]); ?>" width="224" >
                    </a>
                    <div class="info-detail">
                      <span class="itemnum"><?php echo ($dapei["itemnum"]); ?>件搭配宝贝</span>
                      <div class="thumb-goods" style="display: none;">					  
                        <div class="thumb-mL10 clearfix">
						<?php if($dapei['onepic'] == '' ): else: ?>
                          <a href="<?php echo ($dapei["click_url"]); ?>" target="_blank">
                              <img src="<?php echo ($dapei["onepic"]); ?>_72x72xz.jpg" alt="<?php echo ($dapei["title"]); ?>">
                          </a><?php endif; ?>
						<?php if($dapei['twopic'] == '' ): else: ?>
                          <a href="<?php echo ($dapei["click_url"]); ?>" target="_blank">
                              <img src="<?php echo ($dapei["twopic"]); ?>_72x72xz.jpg" alt="<?php echo ($dapei["title"]); ?>">
                          </a><?php endif; ?>
						<?php if($dapei['threepic'] == '' ): else: ?>
                          <a href="<?php echo ($dapei["click_url"]); ?>" target="_blank">
                              <img src="<?php echo ($dapei["threepic"]); ?>_72x72xz.jpg" alt="<?php echo ($dapei["title"]); ?>">
                          </a><?php endif; ?>  
						<?php if($dapei['fourpic'] == '' ): else: ?>
                          <a href="<?php echo ($dapei["click_url"]); ?>" target="_blank">
                              <img src="<?php echo ($dapei["fourpic"]); ?>_72x72xz.jpg" alt="<?php echo ($dapei["title"]); ?>">
                          </a><?php endif; ?>
                        </div>
                      </div>
                    </div>
                  </div>
                  <p class="goods-txt"><?php echo ($dapei["info"]); ?></p>
                  <p class="share-action clearfix">
                      <a href="<?php echo ($dapei["click_url"]); ?>" class="favorite J_favorite" target="_blank">去看看</a>
                  </p>
              </div>
              <div class="share-user">
                  <p class="user-line">
                      <a href="<?php echo ($dapei["click_url"]); ?>" target="_blank" class="user-img">
                          <img src="<?php echo ($dapei["avatar"]); ?>" alt="<?php echo ($dapei["author"]); ?>">
                      </a>
                      <em class="uname"><a href="<?php echo ($dapei["click_url"]); ?>" target="_blank"><?php echo ($dapei["author"]); ?></a></em>
...
<div id="more"></div>
 <div class="main <?php echo C('ftx_site_width');?> clear">
	<div class="clear"></div> 
	<?php if(!empty($page)): ?><div id="J_pagination" class="page">
