...
<div class="jiu-nav <?php echo C('ftx_site_width');?>  seclevelinner main-ftxiacom clear">
            <div class="main-fanli main-my-like">
                <h3 class="title">我的收藏<em class="number">(共<?php echo ($like_count); ?>件商品)</em></h3>
                <span class="like-line"></span>
		<?php if(empty($items_list)): ?><div class="like-tips">
