<?php if (!defined('THINK_PATH')) exit();?><script language="javascript">window.onerror = function(){return true;}</script>
...
var click_url = 'http://detail.tmall.com/item.htm?id=<?php echo ($item["num_iid"]); ?>';
