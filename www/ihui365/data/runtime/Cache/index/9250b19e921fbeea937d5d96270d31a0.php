...
$(function(){
	...
	$('.left-menu-ul li').each(function(i){
		...
		<div class="right">
			<div class="menu-tag">
				<ul>
					<li id="in" class="active"><a href="<?php echo U('user/msg',array('do'=>'in'));?>">收件箱</a></li>
					<li id="out"><a href="<?php echo U('user/msg',array('do'=>'out'));?>">发件箱</a></li>
					<li id="send"><a href="<?php echo U('user/msg',array('do'=>'send'));?>">联系客服</a></li>
				</ul>
			</div>
			<div class="log-table">
				<form>
					...
					<table border="0" cellpadding="0" cellspacing="1">
						...
						<?php if(is_array($msg_list)): $i = 0; $__LIST__ = $msg_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$msg): $mod = ($i % 2 );++$i;?><tr class="tr  <?php if(($mod) == "1"): ?>tr-one<?php endif; ?>">
							<td><input class="checkbox" type='checkbox' name='ids[]' value='<?php echo ($msg["id"]); ?>' id='content_<?php echo ($msg["id"]); ?>' /></td>
							<td align="center"><img src="/static/jky/images/msg<?php echo ($msg["status"]); ?>.gif" width="14" height="10" /></td>
							<td><a class="read" id="<?php echo ($msg["id"]); ?>" href="<?php echo U('ajax/get_msg',array('id'=>$msg['id']));?>"> <?php echo (utf_substr($msg["info"],64)); ?> </a></td>
							<td width="90"><?php echo (date("Y-m-d H:i:s",$msg["add_time"])); ?></td>
							<td><a class="blue-link read" id="<?php echo ($msg["id"]); ?>" href="<?php echo U('ajax/get_msg',array('id'=>$msg['id']));?>">阅读</a></td>
