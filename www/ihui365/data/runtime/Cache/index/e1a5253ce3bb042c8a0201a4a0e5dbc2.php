...
$(function(){
	...
	$('.left-menu-ul li').each(function(i){
		...
		<div class="right">
			<div class="menu-tag">
				<ul>
					<li class="active"><a href="<?php echo U('user/union');?>">我要邀请</a></li>
					<li><a href="<?php echo U('user/unionlist');?>">我的邀请</a></li>			   			   
				</ul>
			</div>
			<div class="u-tip">
				<p>通过您的专属邀请链接邀请好友访问<?php echo C('ftx_site_name');?>，您将获得<?php echo ($union["per_visit"]); echo L('exchange');?>，每天最多可以获得<?php echo ($union["count_visit"]); echo L('exchange');?>！</p>
				<p>如果邀请的好友成功注册<?php echo C('ftx_site_name');?>账号，您将获得<?php echo ($union["per_reg"]); echo L('exchange');?>，您每个月最多可以获得<?php echo ($union["count_reg"]); ?>个<?php echo L('exchange');?>！</p>
			</div>
			...
			<div class="invite_way">
				<div class="w1">
					...
					<div class="link">
						<h4>通过QQ、旺旺等邀请好友</h4>
						<p><input type="text" class="ls copy-link1" style="width:335px" value="<?php echo ($union_url); ?>" readonly="readonly" /><input class="get" id="copy-btn1" type="button" value="" /></p>
					</div>
				</div>
				<div class="w2">
					<div class="icon"></div>
					<div class="link">
						<h4>在自己常去的论坛上挂签名</h4>
						<p><textarea type="text" class="ls ls2 copy-link2" readonly="readonly" />[url=<?php echo ($union_url); ?>]<?php echo C('ftx_site_name');?>[/url]</textarea><input class="get" id="copy-btn2" type="button" value="" /></p>
					</div>
				</div>
				<div class="w3">
					<div class="icon"></div>
					<div class="link">
						...
						<p><textarea type="text" class="ls ls2 copy-link3" readonly="readonly" /><a href="<?php echo ($union_url); ?>" target="_blank"><?php echo C('ftx_site_name');?></a></textarea><input class="get" id="copy-btn3" type="button" value="" /></p>
					</div>
				</div>
				<div class="w5">
					<div class="icon"></div>
					<div class="link">
						...
						<p><textarea type="text" class="ls ls2" style="width:400px;height:80px;" readonly="readonly"/>您可以在自己的QQ空间、人人网、豆瓣网或其它你常去的网站发表博文，以自己的口吻告诉你的朋友，推荐您的朋友加入<?php echo C('ftx_site_name');?>，一起分享购物返现！</textarea></p>
					</div>
				</div>
			</div>
			<div class="invite_tip">
				...
				<ul>
					...
					<li><p>2. 当好友通过您的邀请链接访问<?php echo C('ftx_site_name');?>后，只要TA在1个小时内注册，均为有效；</p></li>
				</ul>
			</div>
