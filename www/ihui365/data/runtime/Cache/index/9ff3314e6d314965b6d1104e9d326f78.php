...
$(function(){
	...
	$('.left-menu-ul li').each(function(i){
		...
		<div class="right">
			<div class="tip-info">
				<script src="__STATIC__/8mobcom/js/jcarousellite_1.0.1.pack.js"></script>
<script type="text/javascript"> 
...
<div class="sys-info" id="user_notice">系统公告：
	<ul>
		<?php if(!empty($notice)): if(is_array($notice)): $i = 0; $__LIST__ = $notice;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li><a class="blue-link" href="<?php echo U('article/read',array('id'=>$val['id']));?>" target="_blank"><?php echo ($val["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; endif; ?>
	</ul>
</div>
				<div class="fr">上次登录时间：<?php echo (date("Y-m-d H:i:s",$info["last_time"])); ?></div>
				<div class="clear"></div>
			</div>
			<div class="user-panel">
				<div class="user-quick">
					<div class="quick-info">
						<div class="my-mb-info">
							...
							&nbsp;我的积分：<span class="f24 org_3"><?php echo ($info["score"]); ?></span> 个
						</div>
						<div class="my-score">
							<p>QQ号码：<b><?php echo ($info["qq"]); ?></b></p>
							<p>电子邮箱：<b><?php echo ($info["email"]); ?></b></p>
				...
				<div class="user-quick user-score">
					...
					<div class="my-score">
						<p>真实姓名：<b><?php echo ($info["realname"]); ?></b></p>
						<p>手机号码：<b><?php echo ($info["mobile"]); ?></b></p>	
						<p>详细地址：<b><?php echo ($info["address"]); ?></b></p>
					</div>  
				</div>
				<div class="clear"></div>
			</div>

			<?php if(empty($info["qq"])): ?><div class="tx_ts">
				<div class="tishitubiao"></div> 
				<p class="fl"><a href="<?php echo U('user/info');?>">请完善您的信息：QQ未填写！ 立即去设置</a></p>
				<span class="close" title="暂时关闭" onclick="$(this).parents('div.tx_ts').hide('slow');"></span>
			</div><?php endif; ?>
			<?php if(empty($info["email"])): ?><div class="tx_ts">
				<div class="tishitubiao"></div> 
				<p class="fl"><a href="<?php echo U('user/info');?>">请完善您的信息：Email未填写！ 立即去设置</a></p>
				<span class="close" title="暂时关闭" onclick="$(this).parents('div.tx_ts').hide('slow');"></span>
			</div><?php endif; ?>
			<?php if(empty($info["realname"])): ?><div class="tx_ts">
				<div class="tishitubiao"></div> 
				<p class="fl"><a href="<?php echo U('user/info');?>">请完善您的信息：真实姓名未填写！ 立即去设置</a></p>
				<span class="close" title="暂时关闭" onclick="$(this).parents('div.tx_ts').hide('slow');"></span>
			</div><?php endif; ?>
			<?php if(empty($info["mobile"])): ?><div class="tx_ts">
				<div class="tishitubiao"></div> 
				<p class="fl"><a href="<?php echo U('user/info');?>">请完善您的信息：手机号码未填写！ 立即去设置</a></p>
				<span class="close" title="暂时关闭" onclick="$(this).parents('div.tx_ts').hide('slow');"></span>
			</div><?php endif; ?>
			<?php if(empty($info["address"])): ?><div class="tx_ts">
				<div class="tishitubiao"></div> 
				<p class="fl"><a href="<?php echo U('user/info');?>">请完善您的信息：详细地址未填写！ 立即去设置</a></p>
				<span class="close" title="暂时关闭" onclick="$(this).parents('div.tx_ts').hide('slow');"></span>
			</div><?php endif; ?>
