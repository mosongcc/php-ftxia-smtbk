...
<div class="main clear mb20 <?php echo C('ftx_site_width');?>">
	...
	<div class="about <?php echo C('ftx_site_width');?> article_list">
		...
		<div class="place-explain">
			...
			&nbsp;&gt;&nbsp; 
			<?php if(!empty($all_cats[$cid]['pid'])): ?><a target="_blank" href="<?php echo U('article/cate',array('id'=>$all_cats[$cid]['pid']));?>"><?php echo ($all_cats[$all_cats[$cid]['pid']]['name']); ?></a>
			&nbsp;&gt;&nbsp;<?php endif; ?>
			<?php if(!empty($cid)): ?><a target="_blank" href="<?php echo U('article/cate',array('id'=>$cid));?>"><?php echo ($all_cats[$cid]['name']); ?></a>
			&nbsp;&gt;&nbsp;<?php endif; ?>
		...
		<div class="about_contain fl ">
			<div class="about_content">
				<ul class="about_notes">
					<?php if(is_array($article_list)): $i = 0; $__LIST__ = $article_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><dl class="newsDl">
					<dt><div id="subwrap">
						<ul>
						<a href="<?php echo U('article/read',array('id'=>$val['id']));?>" target="_blank"><img src="<?php echo ($val["pic_url"]); ?>" title="<?php echo ($val["title"]); ?>" border="0" style=" vertical-align:middle"></a>
						</ul>
						</div>
										</dt>
					<dd class="tit"><a href="<?php echo U('article/read',array('id'=>$val['id']));?>" title="<?php echo ($val["title"]); ?>" target="_blank"><?php echo ($val["title"]); ?></a></dd>
					<dd class="source">来源于：<?php echo C('ftx_site_name');?> <span><?php echo (date("Y-m-d",$val["add_time"])); ?></span></dd>
					<dd class="des"> <?php echo ($val["seo_desc"]); ?><a href="<?php echo U('article/read',array('id'=>$val['id']));?>" title="[详细]" target="_blank">[详细]</a></dd>
		...
		<div class="right_menu fr">
			...
			<div class="widget art_item">
				...
				<?php $tag_item_class = new itemTag;$data = $tag_item_class->lists(array('type'=>'lists','num'=>'10','cache'=>'0','return'=>'data',)); if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="hotshopbox">
