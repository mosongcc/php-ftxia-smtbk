...
<!--main start -->
<div class="main <?php echo C('ftx_site_width');?> mb20 clear" style="overflow:visible">
	<div class="main-newgood">
		<h3 class="megs">
			<i class="tips-icon"></i>
			<div id="ancesdiv">
				<div class="wrapdiv">
					<div id="scroldiv">近期有不法分子冒充<?php echo C('ftx_site_name');?>官方人员，声称收费即可快速上活动，请大家切勿相信！<?php echo C('ftx_site_name');?>为免费促销平台，凡收费上活动的均为骗子，近期<?php echo C('ftx_site_name');?>审核速度加快，请自己报名，不要相信任何代报名和任何QQ群的骗子。&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div>
					<div id="copydiv"></div>
				</div>
			</div>
		</h3>
			...
			<div class="sing_type">
				...
				<div class="con">
					<div class="box">
						...
						<div class="links-all">
							<span class="links"><a target="_blank" href="<?php echo U('index/index');?>">商品展示位置&gt;&gt;</a></span>
							<div class="btns-all"><a href="<?php echo U('baoming/add');?>" class="btn">活动报名</a></div>
						</div>
					</div>


					<?php if(is_array($zc)): $i = 0; $__LIST__ = $zc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 3 );++$i;?><div class="box">
						<p class="box-title"><?php echo ($vol["name"]); ?>专场报名</p>
						<p class="txt"><?php echo ($vol["intro"]); ?></p>
						<div class="links-all">
							<span class="links"><a target="_blank" href="<?php echo U('zc/'.$vol['ename']);?>">商品展示位置&gt;&gt;</a></span>
							<div class="btns-all"><a href="<?php echo U('baoming/add',array('id'=>$vol['id']));?>" class="btn">活动报名</a></div>			
						</div>
