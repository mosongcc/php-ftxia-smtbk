...
<div class="login-main">
		...
		<div class="top">
			<?php if(C('ftx_site_logo') != ''): ?><div class="logo_show"><a href="<?php echo C('ftx_site_url');?>" title="<?php echo C('ftx_site_name');?>" class="jky"><img src="<?php echo C('ftx_site_logo');?>" width="240" height="50" /></a></div>
			<?php else: ?>
				<div class="logo_show"><a href="<?php echo C('ftx_site_url');?>" title="<?php echo C('ftx_site_name');?>" class="jky"><img src="__STATIC__/jky/images/logo3.png" width="240" height="50" /></a></div><?php endif; ?>
		</div>
		<div class="user-login">
			<div class="login-top">
				<h3><i></i>会员通行证</h3>
				<span class="login-r"><a class="active" href="<?php echo C('ftx_site_url');?>">返回首页>></a></span>
			</div>
						<p class="register">还没有帐号，<a class="blu" href="<?php echo U('user/register');?>">立即注册</a></p>
					</div>
		<div class="login-center">
						<div class="content-share">
				<h3>使用合作网站帐号登录</h3>
				<ul>
		<?php if(is_array($oauth_list)): $i = 0; $__LIST__ = $oauth_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('oauth/index', array('mod'=>$val['code']));?>"  class="pub <?php echo ($val["code"]); ?>"><?php echo ($val["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
									</ul>
			</div>
						<div class="content-landing">
				<h3>登录<?php echo C('ftx_site_name');?></h3>
				<form action="<?php echo U('user/login');?>" name="login_form" method="post" id="login_form">
					<ul>
						<li>
						...
						<li>
							<div class="chex">
								...
								<a class="forget " href="<?php echo U('forget/index');?>">忘记密码？</a>
							</div>
						</li>
						<li>
							<div class="btn">
		...
		<p><a href="http://www.miibeian.gov.cn/" rel="nofollow" target="_blank"><?php echo C('ftx_site_icp');?></a> Copyright © 2010-2015 <a href="http://bbs.8mob.com/" target="_blank">8MOB.com</a> V7.0 正式版 all Rights Reserved <a href="http://bbs.8mob.com/" target="_blank">飞天侠淘宝客官方</a>
