...
<div class="pad_lr_10" >
    ...
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="right">
                    <div class="img_border"><a href="http://detail.tmall.com/item.htm?id=<?php echo ($val["num_iid"]); ?>" target="_blank"><img src="<?php echo attach(get_thumb($val['pic_url'], '_s'), 'item');?>" width="32" width="32" class="J_preview" data-bimg="<?php echo attach(get_thumb($val['pic_url'],'_m'), 'item');?>"></a></div>
                </td>
		...
		<td align="center"><b><?php echo ($zc_cate[$val['zc_id']]); ?></b></td>
		<td align="center"><span data-tdtype="edit" data-field="zc_id" data-id="<?php echo ($val["id"]); ?>" class="tdedit"><?php echo ($val["zc_id"]); ?></span></td>
		...
		<td align="center"><?php echo ($val["totalfee"]); ?></td>
		<td align="center"><?php echo ($val["commission"]); ?></td>
		<td align="center"><span data-tdtype="edit" data-field="totalnum" data-id="<?php echo ($val["id"]); ?>" class="tdedit"><?php echo ($val["totalnum"]); ?></span></td>
		<td align="center"><span data-tdtype="edit" data-field="volume" data-id="<?php echo ($val["id"]); ?>" class="tdedit"><?php echo ($val["volume"]); ?></span></td>
	...
	<input type="button" class="btn btn_submit" data-tdtype="batch_action" data-acttype="ajax_form" data-id="move" data-uri="<?php echo U('items/move',array('move'=>2));?>" data-name="id" data-title="批量分类" value="批量分类" /> 
	<input type="button" class="btn btn_submit" data-tdtype="batch_action" data-acttype="ajax_form" data-id="move" data-uri="<?php echo U('items/move',array('move'=>1));?>" data-name="id" data-title="批量加入专场" value="批量专场" /> 
