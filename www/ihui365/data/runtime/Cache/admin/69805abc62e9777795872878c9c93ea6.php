...
<div class="subnav">
	<div class="content_menu ib_a blue line_x">
		<a class="on"><em><?php echo L('clear_cache');?></em></a>
	</div>
</div>
<div class="common-form pad_lr_10">
	<form id="info_form" action="<?php echo u('cache/clear');?>" method="post">
		<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
			...
			<tr>
				<td width="10"><label><input type="checkbox" checked value="field" name="type" class="mr5" data-uri="<?php echo U('cache/clear', array('type'=>'field'));?>"> </label></td>
				<td width="120"><img src="/static/images/admin/folde.gif" width="16" height="14"> data/runtime/Data/_fields </td>
				<td><?php echo L('field_cache');?></td>
				<td><span class="gray mr10"><?php echo L('field_cache_desc');?></span><span id="field_ifm"></span></td>
			</tr>
			<tr>
				<td><label><input type="checkbox" checked value="tpl" name="type" class="mr5" data-uri="<?php echo U('cache/clear', array('type'=>'tpl'));?>"></label></td>
				<td><img src="/static/images/admin/folde.gif" width="16" height="14"> data/runtime/Cache </td>
				<td> <?php echo L('tpl_cache');?></td>
				<td><span class="gray mr10"><?php echo L('tpl_cache_desc');?></span><span id="tpl_ifm"></span></td>
			</tr>
			<tr>
				<td><label><input type="checkbox" checked value="data" name="type" class="mr5" data-uri="<?php echo U('cache/clear', array('type'=>'data'));?>"></label></td>
				<td><img src="/static/images/admin/folde.gif" width="16" height="14"> data/runtime/Data </td>
				<td> <?php echo L('data_cache');?></td>
				<td><span class="gray mr10"><?php echo L('data_cache_desc');?></span><span id="data_ifm"></span></td>
			</tr>
			<tr>
				<td><label><input type="checkbox" checked value="runtime" name="type" class="mr5" data-uri="<?php echo U('cache/clear', array('type'=>'runtime'));?>"> </label></td>
				<td><img src="/static/images/admin/folde.gif" width="16" height="14"> data/runtime/~runtime.php </td>
				<td><?php echo L('runtime_cache');?></td>
				<td><span class="gray mr10"><?php echo L('runtime_cache_desc');?></span><span id="runtime_ifm"></span></td>
			</tr>
			<tr>
				<td><label><input type="checkbox" checked value="logs" name="type" class="mr5" data-uri="<?php echo U('cache/clear', array('type'=>'logs'));?>"></label></td>
				<td><img src="/static/images/admin/folde.gif" width="16" height="14"> data/runtime/Logs</td>
				<td> <?php echo L('logs_cache');?></td>
				<td><span class="gray mr10"><?php echo L('logs_cache_desc');?></span><span id="logs_ifm"></span></td>
			</tr>
			<tr>
				<td><label><input type="checkbox" checked value="js" name="type" class="mr5" data-uri="<?php echo U('cache/clear', array('type'=>'js'));?>"> </label></td>
			...
			<tr>
				<td><label><input type="checkbox" checked value="api" name="type" class="mr5" data-uri="<?php echo U('cache/clear', array('type'=>'api'));?>"> </label></td>
			...
			<tr>
				<td><label><input type="checkbox" checked value="taobao" name="type" class="mr5" data-uri="<?php echo U('cache/clear', array('type'=>'taobao'));?>"> </label></td>
            ...
            <tr>
            	<th></th>
                <td><input type="button" id="J_clear_cache" class="smt mr10" value="<?php echo L('clear');?>"/></td>
                <td></td>
            </tr>
		</table>
	</form>
