    ...
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="right">
                    <?php if(!empty($val['pic_url'])): ?><div class="img_border"><a href="https://item.taobao.com/item.htm?id=<?php echo ($val["num_iid"]); ?>" target="_blank"><img src="<?php echo attach(get_thumb($val['pic_url'], '_s'), 'item');?>" width="32" width="32" class="J_preview" data-bimg="<?php echo attach(get_thumb($val['pic_url '],'_m'), 'item');?>"></a></div><?php endif; ?>
                </td>
