...
<form id="info_form" action="<?php echo U('items_cate/add');?>" method="post">
	...
	<table width="100%" class="table_form">
		<tr> 
			...
			<td>
				<select class="J_cate_select mr10" data-pid="0" data-uri="<?php echo U('items_cate/ajax_getchilds');?>" data-selected="<?php echo ($spid); ?>"></select>
