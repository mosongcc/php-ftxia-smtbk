...
<!--栏目列表-->
<div class="pad_lr_10">
    <div class="J_tablelist table_list" data-acturi="<?php echo U('zc_cate/ajax_edit');?>">
    <table width="100%" cellspacing="0" id="J_cate_tree">
        <thead>
            <tr>
                ...
                <th align="left">专场名称</th>
                <th width="60">专场英文</th>
		<th width="60">Banner图片</th>
		...
		<th width="60"><span data-tdtype="order_by" data-field="bm_xs">报名</span></th>
	...
	<input type="button" class="btn btn_submit" data-tdtype="batch_action" data-acttype="ajax_form" data-id="move" data-uri="<?php echo U('zc_cate/move');?>" data-name="id" data-title="<?php echo L('item_cate_move');?>" value="<?php echo L('move');?>" /> 
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('zc_cate/delete');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
    </div>
</div>
