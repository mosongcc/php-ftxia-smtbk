        ...
        <tbody>
            <tr>
                ...
                <div class="explain_col">
                    ...
                    &nbsp;&nbsp;商品分类：
                    <select class="J_cate_select mr10" data-pid="0" data-uri="<?php echo U('items_cate/ajax_getchilds');?>" data-selected="<?php echo ($search["selected_ids"]); ?>"></select>
 ...
 <div class="J_tablelist table_list" data-acturi="<?php echo U('items/ajax_edit');?>">
    <table width="100%" cellspacing="0">
		...
		<th width="70"><span data-tdtype="order_by" data-field="qq">QQ</span></th>
                ...
                <th width="30"><span data-tdtype="order_by" data-field="pass"><?php echo L('pass');?></span></th>
    	...
    	<tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="right">
			<?php if(!empty($val['pic_urls'])): ?><div class="img_border"><a href="http://detail.tmall.com/item.htm?id=<?php echo ($val["num_iid"]); ?>" target="_blank"><img src="<?php echo attach($val['pic_urls'], 'item');?>" width="32" width="32" class="J_preview" data-bimg="<?php echo attach($val['pic_url'], 'item');?>"></a></div>
			<?php else: ?>
				<div class="img_border"><a href="http://detail.tmall.com/item.htm?id=<?php echo ($val["num_iid"]); ?>" target="_blank"><img src="<?php echo attach(get_thumb($val['pic_url'], '_s'), 'item');?>" width="32" width="32" class="J_preview" data-bimg="<?php echo attach(get_thumb($val['pic_url'],'_m'), 'item');?>"></a></div><?php endif; ?>
                </td>
		...
		<td align="center" class="red"><?php echo ($val["inventory"]); ?></td> 
		<td align="center" class="red"><?php echo ($val["realname"]); ?></td> 
		<td align="center" class="red"><?php echo ($val["mobile"]); ?></td> 
		<td align="center" class="red"><?php echo ($val["qq"]); ?></td> 
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn btn_submit" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('items/do_check');?>" data-name="id" data-msg="<?php echo L('confirm_check');?>" value="<?php echo L('check');?>" />
