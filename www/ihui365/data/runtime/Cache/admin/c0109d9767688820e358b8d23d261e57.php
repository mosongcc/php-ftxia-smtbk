...
<div class="subnav">
    <h1 class="title_2 line_x">天天特价 - 明日预告采集 </h1>
</div>

<div class="pad_lr_10">
    <form id="J_info_form" action="<?php echo U('advanced/setting');?>" method="post">
    <table width="100%" cellspacing="0" class="table_form">
		<tr>
            <th width="150">采集分类 :</th>
            <td><select class="J_tejia_select mr10" data-pid="0" data-uri="<?php echo U('advanced/ajax_getchilds', array('type'=>0));?>"></select></td>
        </tr>
        <tr>
	...
	<tr>
            ...
            <td>  
		<label class="fl" style="width:100px;"><input name="times" type="radio"  value="1" class="input-text">&nbsp;&nbsp;采集今日</label>
		<label class="fl" style="width:100px;"><input name="times" type="radio"  value="2" class="input-text">&nbsp;&nbsp;采集预告</label>
	    </td>
        </tr>
        <tr>
            <th></th>
