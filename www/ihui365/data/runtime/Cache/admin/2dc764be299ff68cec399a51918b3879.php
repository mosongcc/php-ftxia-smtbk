...
<div class="subnav">
	<div class="content_menu ib_a blue line_x">
    	<a class="add fb " href="<?php echo U('ftxrobots/add_do');?>" ><em>添加采集器</em></a>
	<a class="add fb " href="javascript:auto_collect()" ><em>一键自动采集</em></a>
	<a class="add fb " href="javascript:jx_collect(<?php echo ($ftxrobots_collect_data["rid"]); ?>,<?php echo ($ftxrobots_collect_data["p"]); ?>)" ><em>继续采集</em></a>
	<a class="add fb J_showdialog" href="javascript:void(0);" data-uri="<?php echo U('setting/index',array('type'=>'ftxrobots'));?>" data-title="采集设置" data-id="add" data-width="520" data-height="80"><em>采集设置</em></a>
	</div>
...
<div class="pad_lr_10" >
    ...
    <div class="J_tablelist table_list" data-acturi="<?php echo U('ftxrobots/ajax_edit');?>">
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center"><a href="javascript:collect(<?php echo ($val["id"]); ?>,<?php echo ($val["last_page"]); ?>);">继续上次采集</a> |<a href="javascript:collect(<?php echo ($val["id"]); ?>,1);">开始采集</a> |<a href="<?php echo u('ftxrobots/edit', array('id'=>$val['id'], 'menuid'=>$menuid));?>"><?php echo L('edit');?></a> | <a href="javascript:void(0);" class="J_confirmurl" data-uri="<?php echo u('ftxrobots/delete', array('id'=>$val['id']));?>" data-acttype="ajax" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['name']);?>"><?php echo L('delete');?></a></td>
...
<script>
    var collect_url = "<?php echo U('ftxrobots/collect');?>";
    var id = 0;
	var p = 1;
