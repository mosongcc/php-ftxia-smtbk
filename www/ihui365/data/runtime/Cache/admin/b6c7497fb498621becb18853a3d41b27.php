...
<!--栏目列表-->
<div class="pad_lr_10">
    <div class="J_tablelist table_list" data-acturi="<?php echo U('items_cate/ajax_edit');?>">
    <table width="100%" cellspacing="0" id="J_cate_tree">
        <thead>
            <tr>
                ...
                <th width="60"><span data-tdtype="order_by" data-field="status"><?php echo L('show_index');?></span></th>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn btn_submit" data-tdtype="batch_action" data-acttype="ajax_form" data-id="move" data-uri="<?php echo U('items_cate/move');?>" data-name="id" data-title="<?php echo L('item_cate_move');?>" value="<?php echo L('move');?>" /> 
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('items_cate/delete');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
    </div>
</div>
