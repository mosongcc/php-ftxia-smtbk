...
<!--接口列表-->
<div class="pad_10">
    <div class="J_tablelist table_list" data-acturi="<?php echo U('items_site/ajax_edit');?>">
		...
		<td align="center"><span data-tdtype="edit" data-field="ordid" data-id="<?php echo ($val["id"]); ?>" class="tdedit"><?php echo ($val["ordid"]); ?></span></td>
		 <td align="center">
                ...
                <td align="center">
                    <a href="javascript:;" class="J_showdialog" data-uri="<?php echo U('items_site/edit', array('id'=>$val['id']));?>" data-title="<?php echo L('edit');?> - <?php echo ($val["name"]); ?>"  data-id="edit"><?php echo L('edit');?></a> | 
                    <a href="javascript:;" class="J_confirmurl" data-acttype="ajax" data-uri="<?php echo U('items_site/delete', array('id'=>$val['id']));?>" data-msg="<?php echo sprintf(L('confirm_uninstall_one'),$val['name']);?>"><?php echo L('uninstall');?></a>
                </td>
            </tr>
            <?php else: ?>
            <tr>
                ...
                <td><?php echo ($val["author"]); ?></td>
                <td align="center">
                    <a href="javascript:;" class="J_showdialog" data-uri="<?php echo U('items_site/install', array('code'=>$val['code']));?>" data-title="<?php echo L('install');?> - <?php echo ($val["name"]); ?>" data-id="install"><?php echo L('install');?></a>
                </td>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('items_site/delete');?>" data-name="id" data-msg="<?php echo L('confirm_uninstall');?>" value="<?php echo L('uninstall');?>" />
