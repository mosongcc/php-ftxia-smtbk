    ...
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
                ...
                <th width="140"><?php echo L('operations_manage');?></th>
            </tr>
        </thead>
    	<tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="right"><span data-tdtype="edit" data-field="score" data-id="<?php echo ($val["id"]); ?>" class="tdedit"><?php echo ($val["score"]); ?></span></td>
                <td align="center"><?php echo (frienddate($val["reg_time"])); ?></td>
