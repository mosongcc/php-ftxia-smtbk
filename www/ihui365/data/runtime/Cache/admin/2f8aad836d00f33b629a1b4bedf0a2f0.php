...
<div class="pad_lr_10">
    <form id="J_info_form" action="<?php echo U('article_caiji/setting');?>" method="post">
    <table width="100%" cellspacing="0" class="table_form">
		<tr>
            <th width="150">采集分类 :</th>
            <td><select class="J_tejia_select mr10" data-pid="0" data-uri="<?php echo U('article_caiji/ajax_getchilds', array('type'=>0));?>"></select></td>
        </tr>
        <tr>
            <th width="150">对应分类 :</th>
            <td><select class="J_cate_select mr10" data-pid="0" data-uri="<?php echo U('article_cate/ajax_getchilds', array('type'=>0));?>"></select></td>
        </tr>
        <tr>
            <th></th>
...
<script>
$(function(){
    var collect_url = "<?php echo U('article_caiji/collect');?>";
