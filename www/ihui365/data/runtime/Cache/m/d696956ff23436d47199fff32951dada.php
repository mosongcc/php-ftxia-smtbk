	...
	<div class="app">
		...
		<div class="nav_box">
			<nav class="nav" id="nav">
				<ul class="">
					<li><a href="<?php echo U('index/index');?>"><em class="icon icon-jz"></em><span><?php echo C('ftx_site_name');?></span><em class="line"></em></a></li>
					<li><a href="<?php echo U('brand/index');?>"><em class="icon icon-bz"></em><span>品牌团</span><em class="line"></em></a></li>
					<li><a class="active" href="<?php echo U('jiu/index');?>"><em class="icon icon-jk"></em><span>9.9包邮</span><em class="line"></em></a></li>
