...
return array (
  ...
  array (
    ...
    '/^index\/index\/sort\/default$/' => 'index/index?sort=default',
    ...
    '/^index\/so\/k\/(.*)$/' => 'index/so?k=:1',
    '/^index\/cate\/cid\/(\d+)\/p\/(\d+)$/' => 'index/cate?cid=:1&p=:2',
    '/^index\/cate\/cid\/(\d+)$/' => 'index/cate?cid=:1',
    '/^index\/cate\/cid\/(\d+)\/sort\/default$/' => 'index/cate?cid=:1&sort=default',
    '/^index\/cate\/cid\/(\d+)\/sort\/default\/p\/(\d+)$/' => 'index/cate?cid=:1&sort=default&p=:2',
