		...
		<div class="sign_channel">
			<div class="sing_type">
				...
				<div class="con">
					...
					<volist name="zc" id="vol" mod="3">
					<div class="box">
						<p class="box-title">{$vol.name}专场报名</p>
						<p class="txt">{$vol.intro}</p>
						<div class="links-all">
							<span class="links"><a target="_blank" href="{:U('zc/'.$vol['ename'])}">商品展示位置&gt;&gt;</a></span>
							<div class="btns-all"><a href="{:U('baoming/add',array('id'=>$vol['id']))}" class="btn">活动报名</a></div>			
						</div>
					</div>
					</volist>
				</div>
