    ...
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
            ...
            <tr>
                ...
                <td align="left"><p style="width:280px;height:18px;line-height:18px;overflow:hidden;"><a href="{:U('index/item/index',array('id'=>$val['num_iid']))}" target="_blank">{$val.item_name}</p></td>
