			...
			<div class="content_list pad_10">
				<table width="100%" cellspacing="0" class="table_form">
					...
					<tr>
						...
						<td>
						<input type="text" name="title" id="J_title" rel="title_color" class="input-text" size="54" value="{$info.title}" >
					...
					<tr>
						<th>商品标签 :</th>
						<td>
							<input type="text" name="tags" id="J_tags" class="input-text" size="40" value="{$info.tags}" >
							<input type="button" value="{:L('auto_get')}" id="J_gettags" name="tags_btn" class="btn">
						</td>
					</tr>
					<tr>
						<th>{:L('author')} :</th>
						<td><input type="text" name="author" class="input-text" size="54" value="{$info.author}"></td>
					</tr>
		            <tr>
		                <th>详细内容 :</th>
