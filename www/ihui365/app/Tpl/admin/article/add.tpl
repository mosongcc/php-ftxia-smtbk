			...
			<div class="content_list pad_10">
				<table width="100%" cellspacing="0" class="table_form">
					...
					<tr>
						...
						<td>
							<input type="text" name="title" id="J_title" class="input-text" size="54">
					...
					<tr>
						<th>商品标签 :</th>
						<td>
							<input type="text" name="tags" id="J_tags" class="input-text" size="40" >
					...
					<tr>
						<th>{:L('author')} :</th>
						<td><input type="text" name="author" id="author" class="input-text" size="54" value="{$author}"></td>
					</tr>
					<tr>
						<th>详细内容 :</th>
					...
					<tr>
						<th>{:L('publish')} :</th>
		 				<td>
		                		<label>
						<input type="radio" name="status" class="radio_style" value="1"> {:L('yes')} </label>&nbsp;&nbsp;
