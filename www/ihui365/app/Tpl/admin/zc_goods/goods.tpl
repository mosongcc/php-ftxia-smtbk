...
<div class="pad_lr_10" >
    ...
    <table width="100%" cellspacing="0" class="search_form">
        <tbody>
			...
			<input type="hidden" name="m" value="zc_goods" />
			...
			<select class="J_zc_select mr10" data-pid="0" data-uri="{:U('zc_cate/ajax_getchilds', array('type'=>0))}" data-selected="{$search.selected_ids1}"></select>
			<input type="hidden" name="zc_id" id="J_zc_id" value="{$search.zc_id}" />  
			<div class="bk8"></div>
			价格区间 :
...
$('.J_zc_select').zc_select({top_option:lang.all}); 
